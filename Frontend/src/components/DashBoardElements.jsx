...
export function NumericCards() {
    ...
    return (
        ...
        <section className='px-8 py-10 mt-15 flex-col'>
            <div className='mb-5'>
                <h1 className=' text-3xl font-bold text-[#264653]'>Good Evening, {userName}</h1>
...
export function ResumeActivityPlaceholder() {
    const { resumeFileName, resumeUploadDate, atsScore, scanCount } = React.useContext(AppContext)

    return (
        <div className="bg-white rounded-2xl shadow p-5 h-full">
            <h3 className="font-bold text-lg mb-5 text-[#264653]">
                Resume Activity
            </h3>
                ...
                <div className='flex gap-4 items-center'>
                    <div className='rounded-4xl bg-[#2c7752] w-12 h-12 text-white flex items-center justify-center'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            class="lucide lucide-file-text-icon lucide-file-text"><path d="M6 22a2 2 0 0 1-2-2V4a2 
            ...
            <div className='grid grid-cols-2 gap-4 mt-5'>
                ...
                {/* ATS Score */}
                <div className='bg-[#FBF6F1] border border-[#EDE6D8] rounded-2xl p-5'>
                    <div className='flex items-center gap-2 text-[#A16207] mb-4'>
                        ...
                        <p className='text-sm font-semibold'>Last ATS score</p>
                    </div>
                    ...
                    <div className='h-2 bg-[#FDE7B5] rounded-full overflow-hidden'>
                        <div
                ...
                {/* Scan Count */}
                <div className='bg-[#F6FAF8] border border-[#D9EBDD] rounded-2xl p-5'>
