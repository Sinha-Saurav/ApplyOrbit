...
export function ResumeActivityPlaceholder() {
    return (
        <div className="bg-white rounded-2xl shadow p-5 h-full">
            ...
            <div className="h-[250px] rounded-xl border-2 border-dashed border-gray-200 flex items-center justify-center text-gray-400">
                Resume Tailor Activity Coming Soon
            </div>
        </div>
    );
}